...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('AzureViewerService_publisher', (
        ...
        db.send_create_signal('AzureViewerService', ['Publisher'])

        # Adding model 'Author'
        db.create_table('AzureViewerService_author', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('first_name', self.gf('django.db.models.fields.CharField')(max_length=30)),
            ('last_name', self.gf('django.db.models.fields.CharField')(max_length=40)),
            ('email', self.gf('django.db.models.fields.EmailField')(max_length=75, blank=True)),
        ))
        db.send_create_signal('AzureViewerService', ['Author'])

        # Adding model 'Book'
        db.create_table('AzureViewerService_book', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('publisher', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['AzureViewerService.Publisher'])),
            ('publication_date', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
        ))
        db.send_create_signal('AzureViewerService', ['Book'])

        # Adding M2M table for field authors on 'Book'
        db.create_table('AzureViewerService_book_authors', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('book', models.ForeignKey(orm['AzureViewerService.book'], null=False)),
            ('author', models.ForeignKey(orm['AzureViewerService.author'], null=False))
        ))
        db.create_unique('AzureViewerService_book_authors', ['book_id', 'author_id'])


    def backwards(self, orm):
        # Deleting model 'Publisher'
        db.delete_table('AzureViewerService_publisher')

        # Deleting model 'Author'
        db.delete_table('AzureViewerService_author')

        # Deleting model 'Book'
        db.delete_table('AzureViewerService_book')

        # Removing M2M table for field authors on 'Book'
        db.delete_table('AzureViewerService_book_authors')
